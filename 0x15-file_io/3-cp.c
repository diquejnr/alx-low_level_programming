 ...
 * @file: name of the file to buffet
 *
 * Return: point to the new allocated buffer
 */
...
/**
 * close_file - close file descriptions
 * @fd: file descriptor to be clos.
 */
...
/**
 * main - check the files copied
 *
 * @argc: no. of arguments for the program
 *
 * @argv: an array
 *
 * Return: 0 on success.
